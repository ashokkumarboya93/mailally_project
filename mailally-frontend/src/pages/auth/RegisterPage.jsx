...
import { Mail, Lock, Building, ArrowRight, Shield, User, Sparkles, Rocket, BarChart2, Globe, ChevronDown, CheckCircle2, RefreshCw } from 'lucide-react';
import { CometLogo } from '../../components/common/CometLogo';

// Importing custom image from images folder for Register Page
      ...
      >
        ...
        >
          ...
          <div className="my-4 relative z-10 space-y-3">
            ...
            >
              Deploy Your <br />
              Enterprise <span className="text-[#00F0FF] drop-shadow-sm">Workspace</span>
            </h1>
            <p className="text-xs lg:text-sm leading-relaxed text-white/90 max-w-md font-medium">
              Start sending automated campaigns with zero schema restrictions, dynamic custom fields, and multi-provider failover.
            </p>
          </div>

          {/* Center Visual Asset — Custom Image from images directory */}
          <div className="relative z-10 my-4 flex items-center justify-center">
            <div className="p-4 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 shadow-2xl">
              <img
                ...
                alt="Electronic Mail Service Illustration"
          ...
          <div className="grid grid-cols-3 gap-3 relative z-10 pt-2">
            <div className="p-3 rounded-2xl bg-white/15 border border-white/25 backdrop-blur-md flex items-center gap-2.5 shadow-xs">
              ...
              <div className="overflow-hidden">
                <h4 className="text-[11px] font-extrabold text-white truncate">Multi-Tenant</h4>
                <p className="text-[9px] text-white/80 font-medium truncate">Dedicated org workspace</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-2xl bg-white/15 border border-white/25 backdrop-blur-md flex items-center gap-2.5 shadow-xs">
              ...
              <div className="overflow-hidden">
                <h4 className="text-[11px] font-extrabold text-white truncate">High Delivery</h4>
                <p className="text-[9px] text-white/80 font-medium truncate">SES, Brevo & SMTP</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-2xl bg-white/15 border border-white/25 backdrop-blur-md flex items-center gap-2.5 shadow-xs">
              ...
              <div className="overflow-hidden">
                <h4 className="text-[11px] font-extrabold text-white truncate">Role Security</h4>
                <p className="text-[9px] text-white/80 font-medium truncate">Granular RBAC controls</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 p-8 lg:p-12 bg-white flex flex-col justify-between items-center text-slate-800 relative">
          ...
          <div className="w-full max-w-[440px] my-auto space-y-5">
            ...
            {/* Success Banner (Replaces ugly browser alert) */}
            {successMsg && (
              <div className="p-3.5 rounded-xl text-xs font-bold bg-emerald-50 text-emerald-800 border border-emerald-200 animate-fadeIn text-center flex items-center justify-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 text-left">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="John"
                      required
                      className="w-full h-[46px] px-4 pl-10 rounded-xl border-2 border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-100 text-xs font-semibold outline-none text-slate-900 bg-white"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Smith"
                    required
                    className="w-full h-[46px] px-4 rounded-xl border-2 border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-100 text-xs font-semibold outline-none text-slate-900 bg-white"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full h-[50px] rounded-xl font-bold text-white text-sm flex items-center justify-center space-x-2 transition-all duration-200 cursor-pointer shadow-lg shadow-blue-500/25 mt-1"
                style={{
            ...
            <div className="relative flex py-0.5 items-center">
              ...
              <span className="flex-shrink mx-4 text-[11px] font-semibold text-slate-400">or sign up with</span>
              <div className="flex-grow border-t border-slate-200"></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => alert('Google Sign-up OAuth connected stub.')}
                className="flex items-center justify-center gap-2 h-10 px-3 rounded-xl border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-xs font-bold text-slate-700 transition-colors shadow-xs"
              >
              ...
              <button
                type="button"
                onClick={() => alert('Microsoft Sign-up OAuth connected stub.')}
                className="flex items-center justify-center gap-2 h-10 px-3 rounded-xl border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-xs font-bold text-slate-700 transition-colors shadow-xs"
              >
